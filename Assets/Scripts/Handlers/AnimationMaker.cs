...
{
    public List<Sprite> spriteList; //list of sprites for animation
    public List<Sprite> _spriteList {get{return spriteList;} set{spriteList = value; RestartAnimation();}} //list of sprites for animation. !!When the list is modified the animation restarts!!
